...
const products = [
  ...
  {
    id: 'badge-cross',
    name: 'オリジナル缶バッジ（クロスマーク）',
    price: '¥500',
    originalPrice: null,
    image: '23685066-7354-44a7-a578-e962c467dd0d.png',
    badge: null,
    description: '雪音りうプロジェクトのオリジナル缶バッジ。クロスマークデザイン。44mmサイズで推し活やコレクションにぴったり！カバンや小物のワンポイントにも◎',
    tags: ['44mm', '缶バッジ', 'JPYC対応'],
  },
  {
    id: 'badge-monster',
    name: 'オリジナル缶バッジ（モンスター）',
    price: '¥500',
    originalPrice: null,
    image: '5f8f1e85-affd-4645-b3b1-127a477f05ae.png',
    badge: null,
    description: '雪音りうプロジェクトのオリジナル缶バッジ。かわいいモンスターデザイン。イラストがふちまで綺麗にプリント！推し活やコレクションにぴったり♡',
    tags: ['44mm', '缶バッジ', 'JPYC対応'],
  },
  {
    id: 'badge-rabbit',
    ...
    badge: 'New!',
    badgeType: 'new',
    description: '雪音りうプロジェクトのオリジナル缶バッジ。ぷっくりかわいいうさぎデザイン。推し活にぴったり！44mmサイズ。',
    tags: ['44mm', '缶バッジ', 'New', 'JPYC対応'],
  },
  {
    id: 'badge-riu',
    name: 'オリジナル缶バッジ（りうちゃん）',
    price: '¥500',
    originalPrice: null,
    image: 'ff70d8c4-c4ae-4a15-97ca-309095ddbac3.png',
    badge: 'New!',
    badgeType: 'new',
    description: '雪音りうプロジェクトのオリジナル缶バッジ。りうちゃんデザイン。推し活やコレクションに！44mmサイズ。',
    tags: ['44mm', '缶バッジ', 'New', 'JPYC対応'],
  },
  {
    id: 'badge-set',
    ...
    badge: 'セット',
    badgeType: 'set',
    description: '全4種のオリジナル缶バッジをセットにしたお得パック！クロスマーク・モンスター・うさぎ・りうちゃんの4デザイン。並べるとかわいい…！♡ カバンや小物のワンポイントにも◎',
